		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Report de Vôos",
									"targetURL": "#compcezpceui5freestylecdsodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compcezpceui5freestylecdsodata-display": {
								"semanticObject": "compcezpceui5freestylecdsodata",
								"action": "display",
								"description": "Relatorio de Voos",
								"title": "Report de Vôos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.pce.zpce.ui5.freestyle.cds.odata",
									"url": sap.ui.require.toUrl("com/pce/zpce/ui5/freestyle/cds/odata")
								}
							}
						}
					}
